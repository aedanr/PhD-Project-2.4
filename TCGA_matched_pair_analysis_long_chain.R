...
for (i in c("brca", "kirc", "thca", "luad", "lihc", "lusc", "prad", "coad")) {
  for (j in c("exp", "ln")) {
    assign(paste0("res.", i, "_", j), 
           readRDS(here(folder, paste0("results.TCGA.long.chain_", i, "_", j, "HM.rds"))))
...
folder <- "Results/TCGA long chain results Aug 2020"
write.csv(fisher.tests.weak, here(folder, "fisher.tests.weak_known.genes.csv"))
write.csv(fisher.tests.strong, here(folder, "fisher.tests.strong_known.genes.csv"))
...
write.csv(ranksum.tests.weak, here(folder, "ranksum.tests.weak_known.genes.csv"))
write.csv(ranksum.tests.strong, here(folder, "ranksum.tests.strong_known.genes.csv"))
